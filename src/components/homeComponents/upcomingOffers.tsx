...
const cardData = [
    {
      ...
      "details": { "duration": "3Days,2Nights", "date": "12 Aug 2025" },
    ...
    },
    {
      ...
      "details": { "duration": "5Days,4Nights", "date": "25 Sep 2025" },
    ...
    },
    {
      ...
      "details": { "duration": "2Days,1Night", "date": "8 Oct 2025" },
    ...
    },
    {
      ...
      "details": { "duration": "4Days,3Nights", "date": "30 Jul 2025" },
    ...
    },
    {
      ...
      "details": { "duration": "3Days,2Nights", "date": "15 Aug 2025" },
    ...
    },
    {
      ...
      "details": { "duration": "5Days,4Nights", "date": "5 Dec 2025" },
    ...
    },
    {
      ...
      "details": { "duration": "2Days,2Nights", "date": "22 Jul 2025" },
    ...
    },
    {
      ...
      "details": { "duration": "4Days,3Nights", "date": "18 Jan 2026" },
...
export default function UpcomingOffers() {
  return (
    <div className=" mt-[18vh] container mx-auto p-4">
      <h1 className="text-center font-[600] text-[48px]"> Upcoming Offers</h1>
      <div className="mt-20">
        <div className="w-full grid lg:grid-cols-3 xl:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 grid-cols-1  gap-10">
          {cardData.map((card, i) => (
            <div
              key={i}
              className="rounded-2xl bg-white p-8 mt-6 h-[30rem] flex flex-col gap-6 justify-between shadow-xl"
            >
              <h1 className="text-center text-[24px] font-[600]">{card.title}</h1>
              <div className="rounded-3xl h-[30rem] bg-cover bg-center overflow-hidden">
                <img
                  src={card.imageUrl}
                  alt={card.title}
              ...
              <div className="flex flex-col gap-4">
                <div className="w-full flex justify-between h-full">
                  ...
                  >
                    <h4 style={{ backgroundColor: card.tag.bgColor }}>
                      {card.tag.text}
                    </h4>
                  </div>
                ...
                <div className="w-full flex justify-between items-center">
                  <h2>
                    ...
                    <span className="text-[#56565680] text-[18px] font-[500]">
                      {" "}
                      {card.pricing.per}
                    </span>
                  </h2>
